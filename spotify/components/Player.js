...
function Player() {
  ...
  const [currenTrackId, setCurrentIdTrack] = useRecoilState(currentTrackIdState);
  ...
  return (
    <div className="h-24 bg-gradient-to-b from-black to-gray-900 text-white grid align-center content-center grid-cols-1 md:grid-cols-3 text-xs md:text-base px-2 md:px-8">
      {/* Left */}
